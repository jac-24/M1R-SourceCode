# The code for the how border edge correction works
...
point_plot <- function(area_name, tree_name){
  ...
  # Draw a circle around this point that it large enough to have part of it
  # lie outside the window
  draw.circle(x=centre_x_coord,
              y=centre_y_coord,
              nv=100,
              radius=1000, 
              lwd=2,
  ...
  # Draw a circle with radius small enough to lie completely inside the window
  draw.circle(x=centre_x_coord,
              y=centre_y_coord,
              nv=100,
              radius=350,

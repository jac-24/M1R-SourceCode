# The code for the testing of CSR for trees
...
point_plot <- function(area_name, tree_name){
  ...
  unique_points <- unique.ppp(point)
  
  # Use the envelope function to test for CSR using global envelope
  env <- envelope(point, nsim=99, fun=Lest, global=TRUE)
